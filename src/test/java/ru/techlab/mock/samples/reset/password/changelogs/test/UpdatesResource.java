package ru.techlab.mock.samples.reset.password.changelogs.test;
  ...
  public void init(MongoTemplate template, ApplicationContext applicationContext) {
    ...
    userRepository
            .saveAll(Flux.just(
                    ...
                    User.getBuilder().account("tzrb052776").name("D Test 1").password("111222").build(), //
                    User.getBuilder().account("tzrb052777").name("D Test 2").password("111222").build())) //
            .then() //
            .block();
  }
}
